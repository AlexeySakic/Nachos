...
Part of the source code is listed below. Although the main idea remains the same, the implementation is significantly changed from the original design, so codes changed are not highlighted.\\
...
public static void begin(int adults, int children, BoatGrader b)
{
  ...
  /*Main thread scheme starts here*/
  move.acquire();
